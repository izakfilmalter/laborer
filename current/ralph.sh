...
3. Append your progress to the docs/shuru-sandbox-provider/progress.txt file. \
4. Update status of tasks in docs/shuru-sandbox-provider/issues.md \
5. Make a git commit of that feature. \
ONLY WORK ON A SINGLE TASK / FEATURE. \
If, while implementing the feature, you notice that all work \
is complete in docs/shuru-sandbox-provider/issues.md, output <promise>COMPLETE</promise>. \
")
