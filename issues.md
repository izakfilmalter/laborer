...
|---|-------|-----------|--------|
| 1 | Initialize `packages/shared` package | None | Ready |
| 2 | Shared domain types | #1 | Blocked |
| 3 | LiveStore schema — Projects table | #1 | Blocked |
...
| 10 | Initialize `packages/server` package | #1 | Blocked |
