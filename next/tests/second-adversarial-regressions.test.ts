      ...
      const environment = environmentForConfiguredHandler(
        {
          ...
          laborer_memory_authority: "forbidden-memory",
          Laborer_Acp_Private_Token: "forbidden-acp",
          LABORER_CANARY_SOCKET: "forbidden-canary-socket",
          Laborer_Canary_Source_Event_Id: "forbidden-canary-event",
          laborer_canary_thread_id: "forbidden-canary-thread",
          LABORER_ACTION_BRIDGE_AUTHORITY: "forbidden-action-bridge",
          slack_api_token: "forbidden-api",
          Slack_Api_Key: "forbidden-api-key",
          slack_bot_token_workspace: "forbidden-mixed-case-bot",
          Slack_Client_Secret: "forbidden-client",
          SLACK_INCOMING_WEBHOOK_URL: "forbidden-webhook",
          SLACK_SIGNING_SECRET: "forbidden-signing",
          SLACK_TEAM_ID: "safe-explicit-metadata",
          SLACK_USER_TOKEN: "forbidden-user",
        ...
        [
          ...
          "Slack_Api_Key",
          "slack_api_token",
          "slack_bot_token_workspace",
          "laborer_memory_authority",
