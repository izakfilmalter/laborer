/**
 * Resolves the Electron binary path and, on macOS, creates a patched .app bundle
 * with a custom display name and icon so the dock shows "Laborer (Dev)" instead of "Electron".
 */
...
const APP_BUNDLE_ID = 'com.izakfilmalter.laborer'
