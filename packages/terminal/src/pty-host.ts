 ...
 * logging.
 *
 * Why isolated process: node-pty creates tty.ReadStream on PTY master
 * file descriptors. Running node-pty in the main HTTP server process causes
 * SIGHUP to kill interactive shells within milliseconds due to event loop
 * and signal handling interference. Process isolation eliminates this.
 *
