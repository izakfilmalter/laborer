 ...
 *
 * The bug: server infrastructure forks two background fibers (service stack +
 ...
 * 1. `infrastructure.ts` must set `DeferredServicesReady` to `true` after
 ...
 *    behavior
 *
 * @see packages/server/src/infrastructure.ts
